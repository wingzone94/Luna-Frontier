...
Luna Frontierは、Luminous Coreの次期デザインを検証するNodeの子テーマです。現在の最新版は **2.0.0-preview.6** です。Preview版は安定版の `master` 更新チャンネルとは分離して配布します。
...
Preview 6の配布物、導入方法、検証結果は [Luna Frontier 2.0 Preview 6 リリースノート](./docs/preview-6-release.md) を参照してください。各版の詳細は [CHANGELOG.md](./CHANGELOG.md) に記録しています。Lunaは引き続きNodeを親テーマとして使用します。
